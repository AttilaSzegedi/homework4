...
*/}}
{{- define "hw4.labels" -}}
training: {{ .Values.hw4labelstraining }}
app: {{ .Values.hw4labelsapp }}
homework: {{ .Values.hw4labelshomework }}
...
training: {{ .Values.hw4selectorLabelstraining }}
app: {{ .Values.hw4selectorLabelsapp }}
homework: {{ .Values.hw4selectorLabelshomework }}
